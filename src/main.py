...
from SyncData.schema.schema_manager import create_mongodb_schema, validate_mongodb_schema, create_mysql_schema, \
    create_mysql_database, validate_mysql_schema, create_redis_schema, validate_redis_schema
...
def main():
    ...
    #     create_redis_schema(redis_client)
    #     validate_redis_schema(redis_client)
